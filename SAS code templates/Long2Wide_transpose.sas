/*
 PROGRAM:  Long2Wide_transpose.sas
...
** Call macro  **;
   proc sort data= HospVisits out=HV_sort; by MR_Number Name ;  * sort by patient level key variables;
%Long2Wide(HV_sort, HV1, Hosp_Name)
%Long2Wide(HV_sort, HV2, Visit)
%Long2Wide(HV_sort, HV3, ICU)
%Long2Wide(HV_sort, HV4, RsnLeft)
