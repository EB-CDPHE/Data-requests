...
Libname COVID 'J:\Programs\Other Pathogens or Responses\2019-nCoV\Data\SAS Code\data'; run;
   ...
   PROC contents data=COVID.CEDRS_dashboard_constrained varnum; run;

** Admin variables **;

   proc print data= COVID.CEDRS_dashboard_constrained;
     var ID ProfileID EventID ;
run;

   proc freq data= COVID.CEDRS_dashboard_constrained;
 ...
 */
   ...
   proc freq data= COVID.CEDRS_dashboard_constrained;   tables reporteddate; format reporteddate MONYY. ;  run;
   proc freq data= COVID.CEDRS_dashboard_constrained;   tables reporteddate; format reporteddate DOWNAME. ; run;
   proc freq data= COVID.CEDRS_dashboard_constrained;   tables reporteddate; format reporteddate WeekW5. ; run;
