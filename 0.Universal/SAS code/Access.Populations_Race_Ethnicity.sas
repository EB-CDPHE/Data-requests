/**********************************************************************************************
PROGRAM:    Access.Populations_Race_Ethnicity
AUTHOR:		Eric Bush
CREATED:	   June 24, 2021
MODIFIED:   031422: Modified from Access.Populations.sas 
            072021: Modify to be consistent with other "Access.*" programs.	
...
PROC contents data=dbo144.populations_race_ethnicity  varnum ;  run;    
...
** 3. Modify SAS dataset per Findings **;
DATA Pop_RE_temp; set dbo144.populations_race_ethnicity(Rename=(total=Population)); 
run;
...
DATA COVID.CO_Population_Race_Ethnicity ; set Pop_RE_temp_ ;
run;
