/**********************************************************************************************
PROGRAM:  RFI.LaPlata_Hosp_counts_Age.sas
AUTHOR:   Eric Bush
...
***-------------------------------------------------------------***;
   ...
   PROC freq data= COVID.COPHS_fix; tables county_of_residence; run;

DATA COPHS_LP;   set COVID.COPHS_fix;
   where County_of_Residence = 'LA PLATA';
...
DATA DASH.COPHS_LP; set COPHS_LP;
run;
