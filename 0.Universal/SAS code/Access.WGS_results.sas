/**********************************************************************************************
PROGRAM: Access.WGS_results
AUTHOR:  Eric Bush
CREATED: August 20, 2021
MODIFIED:	
PURPOSE:	Connect to CEDRS backend to access whole genome sequencing results
...
** For this request I also deleted code related to Delta variant **;
** DELETED -->   **;
...
PROC SQL;
   ...
   as select distinct   d.ProfileID, d.LastName, d.FirstName, d.MiddleName, d.Birthdate/*, input(d.BirthDate, anydtdtm.) as DOBdate fortmat=dtdate9.*/, d.Gender, 
	...
	where d.ProfileID ne . and e.Deleted ne 1 and e.EventID ne . and l.TestType='COVID-19 Variant Type'  
